...
pretrain_model = AutoModelForCausalLM.from_pretrained('train_multimodal_from_scratch/save/pretrain')
pretrain_model.to(device)

sft_model = AutoModelForCausalLM.from_pretrained('train_multimodal_from_scratch/save/sft')
sft_model.to(device)
