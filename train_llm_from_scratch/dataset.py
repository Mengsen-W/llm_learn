...
class DPODataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        rejected_inputs = self.tokenizer(text=rejected)["input_ids"] + [
            self.tokenizer.eos_token_id
        ]
        chosen_inputs = self.tokenizer(text=chosen)["input_ids"] + [
            self.tokenizer.eos_token_id
        ]
...
class DPODataCollator:
    ...
    def __call__(self, features):
        ...
        return {"input_ids": torch.tensor(inputs_ids), "labels": torch.tensor(labels)}
