...
def train():
    ...
    config = SiglipConfig(
        vision_model_name_or_path="train_siglip_from_scratch/vit-base-patch16-224",
        text_model_name_or_path="chinese-roberta-wwm-ext",
    )
    ...
    dataset = SiglipDataset(
        text_data_path="train_siglip_from_scratch/MUGE/all_texts.jsonl",
